...
${OBJECTDIR}/openair1/PHY/LTE_TRANSPORT/hwdecode.o: openair1/PHY/LTE_TRANSPORT/hwdecode.c 
	${MKDIR} -p ${OBJECTDIR}/openair1/PHY/LTE_TRANSPORT
	${RM} "$@.d"
	$(COMPILE.c) -g -DOAI_EMU -DOPENAIR_LTE -DPCIE_INTERFACE -DPHY_ABSTRACTION_UL -DUSER_MODE -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/openair1/PHY/LTE_TRANSPORT/hwdecode.o openair1/PHY/LTE_TRANSPORT/hwdecode.c
