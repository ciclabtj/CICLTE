...
void fill_dci(DCI_PDU *DCI_pdu, uint8_t sched_subframe, PHY_VARS_eNB *phy_vars_eNB) {
    ...
    uint32_t rballoc = 0x1FFF;
    uint32_t rballoc2 = 0x1FFFF;
    uint32_t rballoc3 = 0x1FFFFFF;
    int subframe = phy_vars_eNB->proc[sched_subframe].subframe_tx;


    unsigned char idx0 = 0, idx1 = 1, idx2 = 2, idx3 = 3, idx4 = 4, idx5 = 5;
    ...
    switch (subframe) {
            ...
            //            ((DCI1_10MHz_FDD_t *) & dlsch_pdu)->TPC = 1;
            //            ((DCI1_10MHz_FDD_t *) & dlsch_pdu)->harq_pid = 0;
            //            ((DCI1_10MHz_FDD_t *) & dlsch_pdu)->mcs = 4;
            //            ((DCI1_10MHz_FDD_t *) & dlsch_pdu)->ndi = subframe & 1;
            //            ((DCI1_10MHz_FDD_t *) & dlsch_pdu)->rv = 1;
        ...
        default:
            ...
            DCI_pdu->dci_alloc[1].dci_length = sizeof_DCI1_10MHz_FDD_t;
            ...
            ((DCI1_10MHz_FDD_t *) & dlsch_pdu)->rv = 1;
            ((DCI1_10MHz_FDD_t *) & dlsch_pdu)->rah = 0;
            memcpy((void*) &DCI_pdu->dci_alloc[1].dci_pdu[0], (void *) &dlsch_pdu, sizeof (DCI1_10MHz_FDD_t));

            //UL
            DCI_pdu->dci_alloc[0].dci_length = sizeof_DCI0_10MHz_FDD_t;
            DCI_pdu->dci_alloc[0].L = 2;
            DCI_pdu->dci_alloc[0].rnti = 0x1235;
            DCI_pdu->dci_alloc[0].format = format0;
            DCI_pdu->dci_alloc[0].ra_flag = 0;

            UL_alloc_pdu_fdd.type = 0; //  /// type = 0 => DCI Format 0, type = 1 => DCI Format 1A   uint32_t type:1;
            UL_alloc_pdu_fdd.hopping = 0; //  /// Hopping flag   uint32_t hopping:1;
            UL_alloc_pdu_fdd.rballoc = computeRIV(50, 0, 50); //  /// RB Assignment (ceil(log2(N_RB_UL*(N_RB_UL+1)/2)) bits)  uint32_t rballoc:11;
            UL_alloc_pdu_fdd.mcs = 4;
            UL_alloc_pdu_fdd.ndi = subframe & 1; //  /// New Data Indicator  uint32_t ndi:1;
            UL_alloc_pdu_fdd.TPC = 0; ///  /// Power Control  uint32_t TPC:2;
            UL_alloc_pdu_fdd.cshift = 0; //  /// DRS Cyclic Shift  uint32_t cshift:3;
            UL_alloc_pdu_fdd.cqi_req = 1; //  /// CQI Request  uint32_t cqi_req:1;
            memcpy((void*) &DCI_pdu->dci_alloc[0].dci_pdu[0], (void *) &UL_alloc_pdu_fdd, sizeof (DCI0_10MHz_FDD_t));
    ...
    switch (subframe) {
        ...
        case 4:
            ...
            DCI_pdu->dci_alloc[1].format = format1;
            DCI_pdu->dci_alloc[1].ra_flag = 0;
            DCI_pdu->dci_alloc[1].dci_length = sizeof_DCI1_20MHz_FDD_t;

            ((DCI1_20MHz_FDD_t *) & dlsch_pdu)->rballoc = rballoc3;
            ((DCI1_20MHz_FDD_t *) & dlsch_pdu)->TPC = 1;
            ((DCI1_20MHz_FDD_t *) & dlsch_pdu)->harq_pid = 0;
            ((DCI1_20MHz_FDD_t *) & dlsch_pdu)->mcs = 4;
            ((DCI1_20MHz_FDD_t *) & dlsch_pdu)->ndi = 1;
            ((DCI1_20MHz_FDD_t *) & dlsch_pdu)->rv = 1;
            ((DCI1_20MHz_FDD_t *) & dlsch_pdu)->rah = 0;
            memcpy((void*) &DCI_pdu->dci_alloc[1].dci_pdu[0], (void *) &dlsch_pdu, sizeof (DCI1_20MHz_FDD_t));



            //UL
            DCI_pdu->dci_alloc[0].dci_length = sizeof_DCI0_20MHz_FDD_t;
            DCI_pdu->dci_alloc[0].L = 2;
            DCI_pdu->dci_alloc[0].rnti = 0x1235;
            DCI_pdu->dci_alloc[0].format = format0;
            DCI_pdu->dci_alloc[0].ra_flag = 0;
            ...
            UL_alloc_pdu_fdd.type = 0; //  /// type = 0 => DCI Format 0, type = 1 => DCI Format 1A   uint32_t type:1;
            UL_alloc_pdu_fdd.hopping = 0; //  /// Hopping flag   uint32_t hopping:1;
            UL_alloc_pdu_fdd.rballoc = computeRIV(100, 0, 100); //  /// RB Assignment (ceil(log2(N_RB_UL*(N_RB_UL+1)/2)) bits)  uint32_t rballoc:11;
            UL_alloc_pdu_fdd.mcs = 4;
            UL_alloc_pdu_fdd.ndi = subframe & 1; //  /// New Data Indicator  uint32_t ndi:1;
            UL_alloc_pdu_fdd.TPC = 0; ///  /// Power Control  uint32_t TPC:2;
            UL_alloc_pdu_fdd.cshift = 0; //  /// DRS Cyclic Shift  uint32_t cshift:3;
            UL_alloc_pdu_fdd.cqi_req = 0; //  /// CQI Request  uint32_t cqi_req:1;
            memcpy((void*) &DCI_pdu->dci_alloc[0].dci_pdu[0], (void *) &UL_alloc_pdu_fdd, sizeof (DCI0_20MHz_FDD_t));
            ...
            UL_alloc_pdu_fdd.type = 0; //  /// type = 0 => DCI Format 0, type = 1 => DCI Format 1A   uint32_t type:1;
            UL_alloc_pdu_fdd.hopping = 0; //  /// Hopping flag   uint32_t hopping:1;
            UL_alloc_pdu_fdd.rballoc = computeRIV(50, 2, 40); //  /// RB Assignment (ceil(log2(N_RB_UL*(N_RB_UL+1)/2)) bits)  uint32_t rballoc:11;
            UL_alloc_pdu_fdd.mcs = 4;
            UL_alloc_pdu_fdd.ndi = subframe & 1; //  /// New Data Indicator  uint32_t ndi:1;
            UL_alloc_pdu_fdd.TPC = 0; ///  /// Power Control  uint32_t TPC:2;
            UL_alloc_pdu_fdd.cshift = 0; //  /// DRS Cyclic Shift  uint32_t cshift:3;
            UL_alloc_pdu_fdd.cqi_req = 0; //  /// CQI Request  uint32_t cqi_req:1;
            memcpy((void*) &DCI_pdu->dci_alloc[0].dci_pdu[0], (void *) &UL_alloc_pdu_fdd, sizeof (DCI0_10MHz_FDD_t));
            printf("cqi:%d TPC:%d cshift:%d mcs:%d rballoc:%d\n", ((DCI0_10MHz_FDD_t *) DCI_pdu->dci_alloc[0].dci_pdu)->cqi_req, ((DCI0_10MHz_FDD_t *) DCI_pdu->dci_alloc[0].dci_pdu)->TPC, ((DCI0_10MHz_FDD_t *) DCI_pdu->dci_alloc[0].dci_pdu)->cshift, ((DCI0_10MHz_FDD_t *) DCI_pdu->dci_alloc[0].dci_pdu)->mcs, ((DCI0_10MHz_FDD_t *) DCI_pdu->dci_alloc[0].dci_pdu)->rballoc);
#endif
            break;
        case 6:
            DCI_pdu->Num_ue_spec_dci = 1;
            ...
            ((DCI1_20MHz_FDD_t *) & dlsch_pdu)->rballoc = rballoc3; /// RB Assignment (ceil(log2(N_RB_DL/P)) bits uint32_t rballoc:17;
            ((DCI1_20MHz_FDD_t *) & dlsch_pdu)->TPC = 1; /// Power Control uint32_t TPC:2;
            ((DCI1_20MHz_FDD_t *) & dlsch_pdu)->harq_pid = 0; /// HARQ Process uint32_t harq_pid:3;
            ((DCI1_20MHz_FDD_t *) & dlsch_pdu)->mcs = 4; /// Modulation and Coding Scheme and Redundancy Version uint32_t mcs:5;
            ((DCI1_20MHz_FDD_t *) & dlsch_pdu)->ndi = 1; /// New Data Indicator uint32_t ndi:1;
            ((DCI1_20MHz_FDD_t *) & dlsch_pdu)->rv = 1; /// Redundancy version uint32_t rv:2;
            ((DCI1_20MHz_FDD_t *) & dlsch_pdu)->rah = 0; /// Resource Allocation Header uint32_t rah:1;
        ...
        default:
            ...
            ((DCI1_20MHz_FDD_t *) & dlsch_pdu)->harq_pid = 0;
            ((DCI1_20MHz_FDD_t *) & dlsch_pdu)->mcs = 4;
            ((DCI1_20MHz_FDD_t *) & dlsch_pdu)->ndi = subframe & 1;
            ((DCI1_20MHz_FDD_t *) & dlsch_pdu)->rv = 1;
            ((DCI1_20MHz_FDD_t *) & dlsch_pdu)->rah = 0;
            memcpy((void*) &DCI_pdu->dci_alloc[0].dci_pdu[0], (void *) &dlsch_pdu, sizeof (DCI1_20MHz_FDD_t));
            break;
    ...
    switch (subframe) {
        ...
        case 1:
            ...
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->TPC = 1;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->harq_pid = 0;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->mcs = 4;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->ndi = subframe & 1;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->rv = 1;
        ...
        default:
            ...
            DCI_pdu->dci_alloc[1].format = format1;
            DCI_pdu->dci_alloc[1].ra_flag = 0;
            DCI_pdu->dci_alloc[1].dci_length = sizeof_DCI1_5MHz_FDD_t;

            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->rballoc = 0X00FF;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->TPC = 1;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->harq_pid = 0;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->mcs = 4;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->ndi = subframe & 1;
            =.,1_5MHz_FDD_t *) & dlsch_pdu)->rv = 1;
           \mcpy((void*) &DCI_pdu->dci_alloc[1].dci_pdu[0], (void *) &dlsch_pdu, sizeof (DCI1_5MHz_FDD_t));
        ...
        case 1:
            ...
            /*downlink*/
            //user1
            DCI_pdu->dci_alloc[idx3].L = 1;
            DCI_pdu->dci_alloc[idx3].rnti = 0x1235;
            DCI_pdu->dci_alloc[idx3].format = format1;
            DCI_pdu->dci_alloc[idx3].ra_flag = 0;
            DCI_pdu->dci_alloc[idx3].dci_length = sizeof_DCI1_5MHz_FDD_t;

            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->rballoc = 0X000F;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->TPC = 1;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->harq_pid = 0;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->mcs = 4;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->ndi = subframe & 1;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->rv = 1;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->rah = 0;
            memcpy((void*) &DCI_pdu->dci_alloc[idx3].dci_pdu[0], (void *) &dlsch_pdu, sizeof (DCI1_5MHz_FDD_t));

            ///usr2
/*
            DCI_pdu->dci_alloc[idx4].L = 1;
            DCI_pdu->dci_alloc[idx4].rnti = 0x1236;
            DCI_pdu->dci_alloc[idx4].format = format1;
            DCI_pdu->dci_alloc[idx4].ra_flag = 0;
            DCI_pdu->dci_alloc[idx4].dci_length = sizeof_DCI1_5MHz_FDD_t;

            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->rballoc = 0X00F0;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->TPC = 1;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->harq_pid = 0;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->mcs = 4;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->ndi = subframe & 1;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->rv = 1;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->rah = 0;
            memcpy((void*) &DCI_pdu->dci_alloc[idx4].dci_pdu[0], (void *) &dlsch_pdu, sizeof (DCI1_5MHz_FDD_t));
*/

            break;
        default:
            //DCI_pdu->Num_ue_spec_dci = 4;
            DCI_pdu->Num_ue_spec_dci = 2;   //cxh

         //   idx0 = 0, idx1 = 1, idx2 = 2, idx3 = 3;
            idx0 = 0, idx1 = 1, idx2 = 1, idx3 = 3;   //cxh
            /*downlink*/
            //user1
            DCI_pdu->dci_alloc[idx2].L = 0;
            DCI_pdu->dci_alloc[idx2].rnti = 0x1235;
            DCI_pdu->dci_alloc[idx2].format = format1;
            DCI_pdu->dci_alloc[idx2].ra_flag = 0;
            DCI_pdu->dci_alloc[idx2].dci_length = sizeof_DCI1_5MHz_FDD_t;

            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->rballoc = 0X1F00; //0X00FF
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->TPC = 1;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->harq_pid = 0;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->mcs = 4;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->ndi = subframe & 1;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->rv = 1;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->rah = 0;
            memcpy((void*) &DCI_pdu->dci_alloc[idx2].dci_pdu[0], (void *) &dlsch_pdu, sizeof (DCI1_5MHz_FDD_t));

            ///usr2
/*
            DCI_pdu->dci_alloc[idx3].L = 0;
            DCI_pdu->dci_alloc[idx3].rnti = 0x1236;
            DCI_pdu->dci_alloc[idx3].format = format1;
            DCI_pdu->dci_alloc[idx3].ra_flag = 0;
            DCI_pdu->dci_alloc[idx3].dci_length = sizeof_DCI1_5MHz_FDD_t;

            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->rballoc = 0X00FF; //0X1F00
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->TPC = 1;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->harq_pid = 0;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->mcs = 4;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->ndi = subframe & 1;
...
*/
            ...
            /*up*/
            DCI_pdu->dci_alloc[idx0].dci_length = sizeof_DCI0_5MHz_FDD_t;
            DCI_pdu->dci_alloc[idx0].L = 0;
            DCI_pdu->dci_alloc[idx0].rnti = 0x1235;
            DCI_pdu->dci_alloc[idx0].format = format0;
            DCI_pdu->dci_alloc[idx0].ra_flag = 0;

            UL_alloc_pdu.type = 0;
            UL_alloc_pdu.hopping = 0;
            UL_alloc_pdu.rballoc = computeRIV(25, 6, 15);
            UL_alloc_pdu.mcs = 4;
            UL_alloc_pdu.ndi = subframe & 1;
            UL_alloc_pdu.TPC = 0;
            UL_alloc_pdu.cshift = 0;
            UL_alloc_pdu.dai = 0;
            UL_alloc_pdu.cqi_req = 1;
            memcpy((void*) &DCI_pdu->dci_alloc[idx0].dci_pdu[0], (void *) &UL_alloc_pdu, sizeof (DCI0_5MHz_TDD_1_6_t));


            //printf("DCI_pdu->dci_alloc[idx0].L:%d\n",DCI_pdu->dci_alloc[idx0].L);

/*
            DCI_pdu->dci_alloc[idx1].dci_length = sizeof_DCI0_5MHz_FDD_t;
            DCI_pdu->dci_alloc[idx1].L = 0;
            DCI_pdu->dci_alloc[idx1].rnti = 0x1236;
            DCI_pdu->dci_alloc[idx1].format = format0;
            DCI_pdu->dci_alloc[idx1].ra_flag = 0;

            UL_alloc_pdu.type = 0;
            UL_alloc_pdu.hopping = 0;
            UL_alloc_pdu.rballoc = computeRIV(25, 0, 2);
            UL_alloc_pdu.mcs = 4;
            UL_alloc_pdu.ndi = subframe & 1;
            UL_alloc_pdu.TPC = 0;
            UL_alloc_pdu.cshift = 0;
            UL_alloc_pdu.dai = 0;
            UL_alloc_pdu.cqi_req = 1;
            memcpy((void*) &DCI_pdu->dci_alloc[idx1].dci_pdu[0], (void *) &UL_alloc_pdu, sizeof (DCI0_5MHz_TDD_1_6_t));
*/
            break;
#else
        case 1:
            ...
            ///user3
            DCI_pdu->dci_alloc[idx5].L = 0;
            DCI_pdu->dci_alloc[idx5].rnti = 0x1237;
            DCI_pdu->dci_alloc[idx5].format = format1;
            DCI_pdu->dci_alloc[idx5].ra_flag = 0;
            DCI_pdu->dci_alloc[idx5].dci_length = sizeof_DCI1_5MHz_FDD_t;

            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->rballoc = 0X1F00;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->TPC = 1;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->harq_pid = 0;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->mcs = 4;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->ndi = subframe & 1;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->rv = 1;
            ((DCI1_5MHz_FDD_t *) & dlsch_pdu)->rah = 0;
            memcpy((void*) &DCI_pdu->dci_alloc[idx5].dci_pdu[0], (void *) &dlsch_pdu, sizeof (DCI1_5MHz_FDD_t));

            break;
        default:
            DCI_pdu->Num_ue_spec_dci = 6;
            ...
            UL_alloc_pdu.type = 0;
            UL_alloc_pdu.hopping = 0;
            UL_alloc_pdu.rballoc = computeRIV(25, 0, 12);
            UL_alloc_pdu.mcs = 4;
            UL_alloc_pdu.ndi = subframe & 1;
            UL_alloc_pdu.TPC = 0;
            UL_alloc_pdu.cshift = 0;
            ...
            UL_alloc_pdu.type = 0;
            UL_alloc_pdu.hopping = 0;
            UL_alloc_pdu.rballoc = computeRIV(25, 12, 8);
            UL_alloc_pdu.mcs = 4;
            UL_alloc_pdu.ndi = subframe & 1;
            UL_alloc_pdu.TPC = 0;
            UL_alloc_pdu.cshift = 0;
            ...
            DCI_pdu->dci_alloc[idx2].dci_length = sizeof_DCI0_5MHz_FDD_t;
            DCI_pdu->dci_alloc[idx2].L = 0;
            DCI_pdu->dci_alloc[idx2].rnti = 0x1237;
            DCI_pdu->dci_alloc[idx2].format = format0;
            DCI_pdu->dci_alloc[idx2].ra_flag = 0;

            UL_alloc_pdu.type = 0;
            UL_alloc_pdu.hopping = 0;
            UL_alloc_pdu.rballoc = computeRIV(25, 20, 5);
            UL_alloc_pdu.mcs = 4;
            UL_alloc_pdu.ndi = subframe & 1;
            UL_alloc_pdu.TPC = 0;
            UL_alloc_pdu.cshift = 0;
            UL_alloc_pdu.dai = 0;
            UL_alloc_pdu.cqi_req = 1;
            memcpy((void*) &DCI_pdu->dci_alloc[idx2].dci_pdu[0], (void *) &UL_alloc_pdu, sizeof (DCI0_5MHz_TDD_1_6_t));
...
void phy_procedures_eNB_TX(unsigned char sched_subframe, PHY_VARS_eNB *phy_vars_eNB, uint8_t abstraction_flag,
    ...
    if (is_pmch_subframe(subframe, subframe, &phy_vars_eNB->lte_frame_parms)) {
        // This is DL-Cell spec pilots in Control region
        generate_pilots_slot(phy_vars_eNB,
                phy_vars_eNB->lte_eNB_common_vars.txdataF[0],
                AMP,
                subframe << 1, 1);
    } else {// this is not a pmch subframe       
        generate_pilots_slot(phy_vars_eNB,
                phy_vars_eNB->lte_eNB_common_vars.txdataF[0],
                AMP,
                subframe << 1, 0);
    ...
    ul_frame = pdcch_alloc2ul_frame(&phy_vars_eNB->lte_frame_parms, frame, subframe);
    ...
    for (i = 0; i < DCI_pdu->Num_common_dci + DCI_pdu->Num_ue_spec_dci; i++) {
        if (DCI_pdu->dci_alloc[i].rnti == SI_RNTI) {
            printf("****[eNB %d SI generate_eNB_dlsch_params_from_dci\n", phy_vars_eNB->Mod_id);
            ...
            if (result == -1) {
                ...
                printf("**Warning [eNB %d Frame %d subframe %d : No available CCE resources for common DCI (SI)!!!\n", phy_vars_eNB->Mod_id, frame, subframe);
            } else {
                printf("[eNB %d Frame %d subframe %d : CCE resource for common DCI (SI)  => %d %u\n", phy_vars_eNB->Mod_id, frame, subframe,
            ...
            printf("****[eNB %d RA generate_eNB_dlsch_params_from_dci\n", phy_vars_eNB->Mod_id);
            generate_eNB_dlsch_params_from_dci(frame,
                    subframe,
                    &DCI_pdu->dci_alloc[i].dci_pdu[0],
                    DCI_pdu->dci_alloc[i].rnti,
            ...
            if (result == -1) {
                ...
                printf("**Warning[eNB %d Frame %d subframe %d : No available CCE resources for common DCI (RA) !!!\n", phy_vars_eNB->Mod_id, frame, subframe);
            } else {
                printf("[eNB %d Frame %d subframe %d : CCE resource for common DCI (RA)  => %d %u\n", phy_vars_eNB->Mod_id, frame, subframe,
            ...
            if (UE_id >= 0) {
                ...
                printf("**warnig no UE [eNB %u][PDSCH] Frame %d : No UE_id with corresponding rnti %u, dropping DLSCH\n",
                        phy_vars_eNB->Mod_id, frame, DCI_pdu->dci_alloc[i].rnti);
            }
        }
        ...
        if (DCI_pdu->dci_alloc[i].format == format0) { // this is a ULSCH allocation
            ...
            if ((DCI_pdu->dci_alloc[i].nCCE = get_nCCE_offset(1 << DCI_pdu->dci_alloc[i].L,
                ...
                LOG_E(PHY, "[eNB %"PRIu8"] Frame %d subframe %d : No available CCE resources (%u) for UE spec DCI (PUSCH %"PRIx16") !!!\n",
                        phy_vars_eNB->Mod_id, frame, subframe, DCI_pdu->nCCE, DCI_pdu->dci_alloc[i].rnti);
            } else {
                LOG_T(PHY, "[eNB %"PRIu8"] Frame %d subframe %d : CCE resources for UE spec DCI (PUSCH %"PRIx16") => %d/%u\n",
                        phy_vars_eNB->Mod_id, frame, subframe, DCI_pdu->dci_alloc[i].rnti,
    ...
    if (phy_vars_eNB->dlsch_eNB_SI->active == 1) {
        printf("DLSCH eNB SI actived in subframe: %d\n", subframe);
    ...
    if (phy_vars_eNB->dlsch_eNB_ra->active == 1) {
        ...
        printf("DLSCH eNB RA actived in subframe: %d\n", subframe);

        input_buffer_length = phy_vars_eNB->dlsch_eNB_ra->harq_processes[0]->TBS / 8;

        for (i = 0; i < input_buffer_length; i++)
            dlsch_input_buffer[i] = 'R'; //(taus()&0xff);
    ...
    // printf("**********************************************************************frame:%d sched_subframe:%d subframe:%d\n",frame,sched_subframe,subframe);
#if 1
    ...
    for (UE_id = 0; UE_id < NUMBER_OF_UE_MAX; UE_id++) {
        if ((phy_vars_eNB->dlsch_eNB[(uint8_t) UE_id][0])&&
            ...
            //printf("DLSCH eNB  actived in subframe: %d\n", subframe);
            harq_pid = phy_vars_eNB->dlsch_eNB[(uint8_t) UE_id][0]->current_harq_pid; //enb 正常下行 发
            ...
            if (phy_vars_eNB->dlsch_eNB[(uint32_t) UE_id][0]->harq_processes[harq_pid]->round == 0) {
                ...
                if (subframe == 4) {
                    ...
                    if (phy_vars_eNB->eNB_UE_stats[(uint32_t) UE_id].cxh_TA < 76800 || phy_vars_eNB->eNB_UE_stats[(uint32_t) UE_id].cxh_TA> -76800) {
                        ((int *) DLSCH_pdu)[0] = phy_vars_eNB->eNB_UE_stats[(uint32_t) UE_id].cxh_TA;
                        FILE *fp = fopen("TIME/TA", "a+");
                        if (0 != phy_vars_eNB->eNB_UE_stats[(uint32_t) UE_id].cxh_TA) {
                            fprintf(fp, "UE： %d,   TA: %d\n", UE_id, phy_vars_eNB->eNB_UE_stats[(uint32_t) UE_id].cxh_TA);
                            phy_vars_eNB->eNB_UE_stats[(uint32_t) UE_id].cxh_TA = 0;
                        }
                        fclose(fp);
                    } else {
                        ((int *) DLSCH_pdu)[0] = 0;
...
void phy_procedures_eNB_RX(const unsigned char sched_subframe, PHY_VARS_eNB *phy_vars_eNB, const uint8_t abstraction_flag, const relaying_type_t r_type) {
    //make change keep log
    //printf("############phy_procedures_eNB_RX###################\n\n\n");
    //RX processing
    UNUSED(r_type);
    ...
    const int subframe = phy_vars_eNB->proc[sched_subframe].subframe_rx;
    const int frame = phy_vars_eNB->proc[sched_subframe].frame_rx;
    printf("sched_subframe %d subframe %d frame %d\n", sched_subframe, subframe, frame);
    ...
    if (abstraction_flag == 0) {
        for (l = 0; l < phy_vars_eNB->lte_frame_parms.symbols_per_tti / 2; l++) {
            ...
            struct timespec start_timefep, end_timefep;
            clock_gettime(CLOCK_PROCESS_CPUTIME_ID, &start_timefep);
            ...
            clock_gettime(CLOCK_PROCESS_CPUTIME_ID, &end_timefep);
    ...
    for (i = 0; i < NUMBER_OF_UE_MAX; i++) {
        ...
        /*
          ...
          break;
         */
        //        msg("[eNB %d][PUSCH %d] frame %d subframe %d Scheduling PUSCH/ULSCH Reception for rnti %x (UE_id %d)phy_vars_eNB->ulsch_eNB[i]->harq_processes[harq_pid]->subframe_scheduling_flag:%d\n",
        //                phy_vars_eNB->Mod_id, harq_pid,
        //                frame, subframe, phy_vars_eNB->ulsch_eNB[i]->rnti, i, phy_vars_eNB->ulsch_eNB[i]->harq_processes[harq_pid]->subframe_scheduling_flag);
        if ((phy_vars_eNB->ulsch_eNB[i]) &&
                (phy_vars_eNB->ulsch_eNB[i]->rnti > 0) &&
                (phy_vars_eNB->ulsch_eNB[i]->harq_processes[harq_pid]->subframe_scheduling_flag == 1)) {
            //            printf( " phy_vars_eNB->ulsch_eNB[%d]->rnti : %x,  nb_rb: %d,  first_rb:%d\n", i, phy_vars_eNB->ulsch_eNB[i]->rnti,
            //                    phy_vars_eNB->ulsch_eNB[i]->harq_processes[0]->nb_rb, phy_vars_eNB->ulsch_eNB[i]->harq_processes[0]->first_rb );
            pusch_active = 1;
            ...
            struct timespec start_timeulsch, end_timeulsch;
            clock_gettime(CLOCK_PROCESS_CPUTIME_ID, &start_timeulsch);
            ...
            clock_gettime(CLOCK_PROCESS_CPUTIME_ID, &end_timeulsch);
            static long long time_ulsch = 0;
            time_ulsch += diff_time(end_timeulsch, start_timeulsch).tv_nsec;
            


            struct timespec start_timedecoding, end_timedecoding;
            clock_gettime(CLOCK_PROCESS_CPUTIME_ID, &start_timedecoding);
            ...
            clock_gettime(CLOCK_PROCESS_CPUTIME_ID, &end_timedecoding);
            static long long time_decoding = 0;
            time_decoding += diff_time(end_timedecoding, start_timedecoding).tv_nsec;
          
            static float cxh_error_rate[2] = {0, 0};
            static unsigned int cxh_right_cnt[2] = {1, 1};
            static unsigned int cxh_error_cnt[2] = {0, 0};
            if (ret <= 4) {
#if 1
                if (sched_subframe != 1)
                    cxh_right_cnt[i] += 1;
                for (int ii = 0; ii < 15; ii++) {
                    printf("%c", phy_vars_eNB->ulsch_eNB[i]->harq_processes[harq_pid]->b[ii]);
                }
                ...
                if (sched_subframe != 1) {
                    ...
                    LOG_E(PHY, "                                  uplink is  error\n");
                }
            }
            cxh_error_rate[i] = 100.0*(float)cxh_error_cnt[i] / ((float) cxh_right_cnt[i] + (float) cxh_error_cnt[i]);
            if (sched_subframe == 9)
                printf("                           (right_cnt: %d,  error_cnt:%d)       error_rate: %f%  \n", cxh_right_cnt[i], cxh_error_cnt[i], cxh_error_rate[i]);
...
void phy_procedures_eNB_lte(unsigned char subframe, PHY_VARS_eNB **phy_vars_eNB, uint8_t abstraction_flag,
    ...
    for (CC_id = 0; CC_id < MAX_NUM_CCs; CC_id++) {
        ...
        if ((((phy_vars_eNB[CC_id]->lte_frame_parms.frame_type == TDD)&&
            ...
            //printf("Frame process time :%ld,%ld\n", diff_time(end_time, start_time).tv_sec, diff_time(end_time, start_time).tv_nsec);
            static  long int  time_all = 0;
            time_all += diff_time(end_time, start_time).tv_nsec;
            if (subframe == 9) {
                FILE *fp = fopen("TIME/enbrx_time", "a+");
                fprintf(fp, "%ld ns\n", time_all);
                fclose(fp);
                time_all = 0;
            }
        ...
        // printf("*************************************************subframe%d phy_vars_eNB[CC_id]->proc[subframe].frame_tx:%d\n",subframe,phy_vars_eNB[CC_id]->proc[subframe].frame_tx);
        //        phy_vars_eNB[CC_id]->proc[subframe].frame_tx++;
        //        phy_vars_eNB[CC_id]->proc[subframe].frame_rx++;
        // printf("*************************************************subframe%d phy_vars_eNB[CC_id]->proc[subframe].frame_tx:%d\n",subframe,phy_vars_eNB[CC_id]->proc[subframe].frame_tx);
        if (phy_vars_eNB[CC_id]->proc[subframe].frame_tx == 1024) // defined in impl_defs_top.h
