...
static asn_per_constraints_t asn_PER_memb_ra_PreambleIndex_constr_2 = {
	{ APC_CONSTRAINED,	 6,  6,  0,  63 }	/* (0..63) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_ra_PRACH_MaskIndex_constr_3 = {
...
static asn_TYPE_tag2member_t asn_MAP_RACH_ConfigDedicated_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ra-PreambleIndex at 1409 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* ra-PRACH-MaskIndex at 1410 */
};
