...
static asn_per_constraints_t asn_PER_memb_bandEUTRA_constr_2 = {
...
static asn_TYPE_tag2member_t asn_MAP_SupportedBandEUTRA_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* bandEUTRA at 2488 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* halfDuplex at 2489 */
};
