...
static asn_TYPE_tag2member_t asn_MAP_SystemInformationBlockType7_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* t-ReselectionGERAN at 986 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* t-ReselectionGERAN-SF at 987 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* carrierFreqsInfoList at 988 */
};
