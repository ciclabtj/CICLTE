...
//   //make change zyb
//   l_rlc_p->input_sdus = (rlc_am_tx_sdu_management_t*) malloc (10*sizeof(rlc_am_tx_sdu_management_t));
//   //l_rlc_p->input_sdus[l_rlc_p->next_sdu_index].mem_block  = (mem_block_t*) malloc (sizeof(mem_block_t));
//   ///////////////////////
