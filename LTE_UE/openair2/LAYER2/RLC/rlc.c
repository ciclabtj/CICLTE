...
//  ///////////
  h_rc = hashtable_get(rlc_coll_p, key, (void**)&rlc_union_p);
//  h_rc = HASH_TABLE_OK;//make change zyb
  if (h_rc == HASH_TABLE_OK) {
    rlc_mode = rlc_union_p->mode;
//      //make change zyb
//      rlc_mode = RLC_MODE_AM;
  } else {
...
//                        //make change
//                        FILE *fp=fopen("/home/zhaiyubo/zyb/openair2_single/rlc_input.txt","w");
//                        fwrite(sdu_pP->data,sdu_sizeP,1,fp);
//                        fclose(fp);
//                        //////////////////
//      
      if (new_sdu_p != NULL) {
