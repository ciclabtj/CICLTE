...
static asn_per_constraints_t asn_PER_memb_cellIdentity_constr_3 = {
...
static asn_TYPE_tag2member_t asn_MAP_CellGlobalIdUTRA_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* plmn-Identity at 1826 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* cellIdentity at 1827 */
};
