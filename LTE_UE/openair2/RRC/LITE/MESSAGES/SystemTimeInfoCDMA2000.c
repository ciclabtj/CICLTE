...
static asn_TYPE_tag2member_t asn_MAP_cdma_SystemTime_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* synchronousSystemTime at 1966 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* asynchronousSystemTime at 1967 */
};
...
static asn_TYPE_tag2member_t asn_MAP_SystemTimeInfoCDMA2000_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* cdma-EUTRA-Synchronisation at 1964 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* cdma-SystemTime at 1966 */
};
